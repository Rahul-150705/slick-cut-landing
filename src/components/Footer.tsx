...
import { Instagram, Phone, Mail, MapPin, Scissors } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">
              Your destination for premium men's grooming and exceptional service.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href="mailto:info@elitecuts.com" className="flex items-center gap-2 text-sm text-muted-foreground hover:text-primary transition-colors">
