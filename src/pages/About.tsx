          ...
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg prose-invert max-w-none animate-fade-in">
              ...
              <p className="text-lg text-muted-foreground">
                At California BarberShop, we're not just creating great looks – we're building lasting relationships with our clients and contributing to the confidence of our community, one haircut at a time.
              </p>
            </div>
          </div>
        </div>
